...
<head>
    ...
    <script type="text/javascript" src="assets/js/programmes.js"></script>
</head>
<body>
...
<div class="page-container">
    <div class="page-content">
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <?php include 'portlets/portlet_programmes_infra.php' ?>
                </div>
                <div class="col-lg-6">
                    <?php include 'portlets/portlet_programmes_systems.php' ?>
                </div>
            </div>
