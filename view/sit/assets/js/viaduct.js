...
/*            dataset.forEach(function(d){
    ...
    return {
        init: function() {
            ...
            _imageGallery();
            _fillableGauge("fillgauge1",24.7);
            var dataset1 = [{ name: 'Actual', count: 50 }, { name: 'Planned', count: 50 }];
            var dataset2 = [{ name: 'Actual', count: 32 }, { name: 'Planned', count: 50 }];
            var dataset3 = [{ name: 'Actual', count: 26 }, { name: 'Planned', count: 40 }];
            var dataset4 = [{ name: 'Actual', count: 15 }, { name: 'Planned', count: 20 }];
            var dataset5 = [{ name: 'Actual', count: 5 }, { name: 'Planned', count: 5 }];
            _pieWithProgress("#kpi_piling", 146, dataset1);
            _pieWithProgress("#kpi_pilecap", 146, dataset2);
            _pieWithProgress("#kpi_pier", 146, dataset3);
            _pieWithProgress("#kpi_pierhead", 146, dataset4);
            _pieWithProgress("#kpi_uthrough", 146, dataset5);
            _segmentedGauge("#segmented_gauge", 300, 0, 100, 3);
        }
    }
}();

document.addEventListener('DOMContentLoaded', function() {
    ViaductProgress.init();
});
