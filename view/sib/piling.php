...
<head>
    ...
    <script type="text/javascript" src="assets/js/piling.js"></script>
</head>
<body>
...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h5>
                <span class="text-semibold"><i class="icon-align-bottom position-left"></i> Section 1 - Piling Progress</span>
        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php include 'portlets/portlet_section_kpi_detail_piling.php' ?>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
