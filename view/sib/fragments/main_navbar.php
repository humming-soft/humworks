<div class="navbar-header">
    <a class="navbar-brand" href="projects.php"><img src="../../assets/images/logo.png" alt=""></a>
...
<div class="navbar-collapse collapse" id="navbar-mobile">
    <ul class="nav navbar-nav navbar-right">
                    ...
                    <div class="panel-body">
                        <div class="tabbable">
                            <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                                <li class="active"><a href="#issue-overall" data-toggle="tab" aria-expanded="true">Overall <i class="icon-menu7 position-right"></i></a></li>
                                <li class=""><a href="#issue-section1" data-toggle="tab" aria-expanded="false">Section 1 <i class="icon-mention position-right"></i></a></li>
                                <li class=""><a href="#issue-section2" data-toggle="tab" aria-expanded="false">Section 2 <i class="icon-mention position-right"></i></a></li>
                                <li class=""><a href="#issue-section3" data-toggle="tab" aria-expanded="false">Section 3 <i class="icon-mention position-right"></i></a></li>
                            </ul>

                            <div class="tab-content">
                                <div class="tab-pane active" id="issue-overall">
                                    To use in tabs with equal widths add <code>.nav-justified</code> and icon markup to the tab nav.
                                </div>

                                <div class="tab-pane" id="issue-section1">
                                    Food truck fixie locavore, accusamus mcsweeney's marfa nulla single-origin coffee squid laeggin.
                                </div>

                                <div class="tab-pane" id="issue-section2">
                                    DIY synth PBR banksy irony. Leggings gentrify squid 8-bit cred pitchfork. Williamsburg whatever.
                                </div>

                                <div class="tab-pane" id="issue-section3">
        ...
        <li class="dropdown dropdown-user">
            <a class="dropdown-toggle" data-toggle="dropdown">
                <img src="../../assets/images/avatar/default_avatar.png" alt="">
                <span>admin@acreworks.com.my</span>
                <i class="caret"></i>
            </a>
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                ...
                <li><a href="../login.php?login=tdDgsj80GHSg$jkn&role=stack3"><i class="icon-switch2"></i> Logout</a></li>
            </ul>
        </li>
    </ul>
</div>
