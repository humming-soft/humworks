...
<!--		<div id="pop_label">
		...
		<div id="pop_value">
			<span class="set1">5.41%</span>
			<span class="set2">15.43%</span>
			<span class="set3">10.02%</span>
		...
		<div id="pop_label_1">
			...
			<span class="set2">Project Spend to-date (RM)</span>
			<span class="set3">PDP Reimbursable (RM)</span>
			<span class="set4">WCP's Payment (RM)</span>
		</div>
		<div id="pop_value_1">
			<span class="set1">329,925,181</span>
			<span class="set2">213,843,543</span>
			<span class="set3">52,415,638</span>
	...
	<div id="plate_legend">
		...
		<div id="pl_label_content">
			...
			<span class="set100">CLQ</span>
			<span class="set200">Depot</span>
			<span class="set300">Parking</span>
			<span class="set400">Training</span>
...
<!--			<span class="set1"><a href="mspr.php">P</a></span>
		...
		<div id="pl_package">
<!--			<a id="pl_package_V201" href="viaduct.php" class="set1">GS10</a>
			<a id="pl_package_V202" href="viaduct.php" class="set2">GS09</a>
			<a id="pl_package_V203" href="viaduct.php" class="set3">GS08</a>
			<a id="pl_package_UG" href="viaduct.php" class="set4">GS07</a>
			<a id="pl_package_V204" href="viaduct.php" class="set5">GS06</a>
			<a id="pl_package_V205" href="viaduct.php" class="set6">GS05</a>
			<a id="pl_package_V206" href="viaduct.php" class="set7">GS04</a>
			<a id="pl_package_V207" href="viaduct.php" class="set8">GS03</a>
			<a id="pl_package_V208" href="viaduct.php" class="set9">GS02</a>
			<a id="pl_package_V209" href="viaduct.php" class="set10">GS01</a>
			<a id="pl_package_V210" href="ug.php" class="set11">UG</a>-->
		</div>
		<div id="pl_phase">
