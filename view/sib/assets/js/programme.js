    ...
    $(function () {
        ...
        Highcharts.chart('scurve_overall_1', {
            ...
            series: [{
                ...
                name: 'Actual',
                data: [0.15,0.23,0.75,1.60,3.1,5.46,8.95,9.67,10.95,11.36,12.99,13.2,14.45],
                color: '#04B152'
            }],
        });
        ...
        Highcharts.chart('scurve_section_1', {
            ...
            series: [{
                ...
                name: 'Actual',
                data: [0.15,0.23,0.75,1.60,3.1,2.46,4.95,6.67,9.40,11.58,13.90,17.72,24.80],
                color: '#04B152'
            }],
        });
        ...
        Highcharts.chart('scurve_section_2', {
            ...
            series: [{
                ...
                name: 'Actual',
                data: [0.15,0.23,0.75,1.60,1.70,1.80,2.35,3.67,4.95,5.36,8.99,16.2,28.10],
                color: '#04B152'
            }],
        });
        ...
        Highcharts.chart('scurve_section_3', {
            ...
            series: [{
                ...
                name: 'Actual',
                data: [0,0,0.66,1,1,2.63,6.17,11.01,12.36,9.86,7.24,6,5.90],
                color: '#04B152'
            }],
        });
    });
