...
<head>
    ...
    <script type="text/javascript" src="assets/js/internal_awsb_target.js"></script>
</head>
<body>
...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h5>
                <span class="text-semibold"><i class="icon-align-bottom position-left"></i> Section 1 - Piers</span>
        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php include 'portlets/portlet_internal_awsb_piercap.php' ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <?php include 'portlets/portlet_internal_awsb_piercolumn.php' ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <?php include 'portlets/portlet_internal_awsb_pierhead.php' ?>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
